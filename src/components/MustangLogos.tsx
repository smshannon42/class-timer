...
export function MustangShield({ className = "w-14 h-14" }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* Mustang Stallion Head & Mane - Red Silhouette */}
      <path
      ...
      {/* Stallion Mane Details */}
      <path d="M 260 160 Q 305 185 315 225 C 290 200 270 185 260 160 Z" fill="#0047BA" />
      <path d="M 290 210 Q 335 245 330 290 C 305 255 290 235 290 210 Z" fill="#0047BA" />
      <path d="M 270 280 Q 310 320 295 365 C 280 330 270 305 270 280 Z" fill="#0047BA" />

      {/* Mustang Eye & Brow */}
      <path d="M 210 205 Q 235 195 230 215 Q 205 215 210 205 Z" fill="#FFFFFF" />
      <path d="M 185 245 Q 195 255 180 265 C 170 260 175 250 185 245 Z" fill="#FFFFFF" />
    </svg>
  );
}
...
export function MustangWordmark({ className = "h-10" }: { className?: string }) {
  return (
    <div className={`flex flex-col select-none justify-center leading-none ${className}`}>
      <span className="text-2xl sm:text-3xl font-black tracking-tight text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] font-sans">
        MUSTANG
      </span>
      <span className="text-xs sm:text-sm font-black tracking-[0.35em] text-[#E32636] drop-shadow-[0_1px_3px_rgba(0,0,0,0.7)] mt-0.5">
        PULSE
      </span>
    </div>
  );
